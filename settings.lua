...
function CVARs:InitSettings()
    ...
    CVARs:SetVersion(AddonName, 134063, "1.2.49")
    cvars_settings = CVARs:CreateFrame(
        {
            ...
            ["sw"] = 520,
            ["sh"] = 700,
            ["title"] = format("CVARs |T134063:16:16:0:0|t v|cff3FC7EB%s", "1.2.49")
        }
    )
    ...
    CVARs:CreateMinimapButton(
        {
            ...
            ["icon"] = 134063,
            ["dbtab"] = CVTAB,
            ["vTT"] = {{"CVArs |T134063:16:16:0:0|t", "v|cff3FC7EB1.2.49"}, {"Leftclick", "Options"}, {"Rightclick", "Hide Minimap"}},
            ["funcL"] = function()
